...
// Obtemos os dados do carrinho e as funções do store
const {
  carrinho,
  aumentar,
  diminuir,
...
onMounted(() => {
  cartStore.carregarCarrinho() // Função para carregar o carrinho do localStorage
})
</script>
...
<template>
  ...
  <div class="mainCart">
    ...
    <!-- Área para limpar o carrinho e mostrar o total -->
    <div class="last">
